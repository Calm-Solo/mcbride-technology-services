                ...
                <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
                    <div className="group flex overflow-hidden p-2 [--gap:1rem] [gap:var(--gap)] flex-row [--duration:80s]">
                        ...
                        <div
                            ...
                            style={{ animationDelay: 'calc(var(--duration) / 2)' }}>
                            {[...Array(4)].map((_, setIndex) =>
                    ...
                    <div
                        className={`pointer-events-none absolute inset-y-0 left-0 hidden w-1/3 bg-gradient-to-r from-st_darkest sm:block`}
                    />
                    <div
                        className={`pointer-events-none absolute inset-y-0 right-0 hidden w-1/3 bg-gradient-to-l from-st_darkest sm:block`}
                    />
                </div>
            </div>
        </section>
